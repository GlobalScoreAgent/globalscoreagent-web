...
import { Shield, Zap, Link2, Eye, TrendingUp, Globe } from 'lucide-react';
...
const benefitIcons = [Zap, Shield, Link2, Eye, TrendingUp, Globe];

export default function HumiBenefitsSection() {
  const { language } = useLanguage();
  const { benefits } = humiCopy;
