...
import HumiKpiOverlay from '@/components/humi/HumiKpiOverlay';
import { humiCopy } from '@/content/humi/copy';
import { pick } from '@/content/marketing/i18n';
import { HUMI_HERO_VIDEO_SRC } from '@/content/marketing/media';

export default function HumiHero() {
  ...
  return (
    ...
    >
      <video
        ...
        aria-hidden
      >
        <source src={HUMI_HERO_VIDEO_SRC} type="video/mp4" />
      </video>

      <HumiKpiOverlay className="absolute right-3 top-20 z-20 sm:right-5 sm:top-20 md:right-8 md:top-[4.5rem]" />
