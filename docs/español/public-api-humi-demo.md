...
**Fuente canónica de infra:** repo **[public-api](https://github.com/GlobalScoreAgent/public-api)** (`gsa-api-router`). No editar el Worker en este monorepo.
...
3. Workers Builds conectado a `public-api` (o `wrangler deploy`).
