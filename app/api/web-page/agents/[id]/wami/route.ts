...
import { fetchAgentWamiIndex } from '@/lib/agents/agentDetailFetch';
...
export async function GET(
  ...
  try {
    ...
    const result = await fetchAgentWamiIndex(supabase, numericId, lookupBy);
    ...
    console.error('Public agent WAMI API:', err);
    return NextResponse.json(
      {
